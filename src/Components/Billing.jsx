...
export const Billing = ({ billID = "", loaderDisplay }) => {
   ...
   useEffect(() => {
      ...
      bill.billItems.forEach((item) => {
         console.log('total sum', item.itemDetail["itemSellingPricePerUnit"], item["itemQuantityInBill"]);
         totalSum += Math.ceil(
                              ...
                              {itemObj.slabPricing?.map((item, index) => {
                                 return (
                                    <div key={index} style={{ display: "flex" }}>
                                       <input type="number" style={{ width: "40px", textAlign: "center", border: 'none', outline: 'none' }} value={item[1]} disabled /> -
                                       <input type="number" style={{ width: "40px", textAlign: "center", border: 'none', outline: 'none' }} disabled defaultValue={index !== itemObj.slabPricing.length - 1 ? Number(itemObj.slabPricing[index + 1][1]) - 1 : ''} /> =
                                       <input type="number" style={{ width: "40px", textAlign: "center", border: 'none', outline: 'none' }} value={item[2]} disabled />
                                    </div>
                                 )
                              })}
                           </div>
