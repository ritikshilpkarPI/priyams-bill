...
//         end_Date = String(new Date(end_Date).toLocaleDateString());
//         start_Date = new Date();
//         start_Date = String(new Date(start_Date).toLocaleDateString());
...
//                                                     <tbody>
//                                                         {item.useByDate.map((expiry,index) => {
//                                                             return (
//                                                                 <tr key={index}>
...
const ExpiredItemTable = ({ day }) => {
    ...
    useEffect(() => {
        const getExpiredData = async () => {
            const endDate = addDays(startDateValue, day);

            const response = await getExpiredApiData(startDateValue, endDate);
    ...
    return (
        <>
            ...
            {day === 30 && <DatePicker placeholder="Start date" value={endDateValue} withAsterisk onChange={setEndDateValue} />}
