...
export const PaymentDetailAndBillPanel = () => {
  ...
  return (
    <Flex direction="column">
        <PaymentDetailsForm purchaseOrderId={purchaseOrder?._id} paymentDetailIdx={(purchaseOrder?.purchaseDetails?.length || 0) + 2} />
        <PaymentDetailTable purchaseOrderId={purchaseOrder?._id} totalPaidAmount={purchaseOrder?.totalPaidAmount || 0} />
    </Flex>
  )
}