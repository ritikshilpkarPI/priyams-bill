          ...
          <table className="sell-details-table">
            <thead className="sell-details-table-thead">
              <tr className="sell-details-table-thead-tr">
                ...
                <th className="sell-details-table-thead-tr-th">
                Last 3 Month Sold : <span className='sell-details-table-thead-tr-th-span' > {lastThreeMonthDate} - {currentDate} </span> 
                </th>
                <th className="sell-details-table-thead-tr-th">
                  Yearly Sold : <span className='sell-details-table-thead-tr-th-span' > {lastYearDate} - {currentDate} </span> 
                </th>
                <th className="sell-details-table-thead-tr-th">
