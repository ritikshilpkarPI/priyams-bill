                ...
                <table className='unpaidPurchaseOrder-table'>
                    <thead className='unpaidPurchaseOrder-table-thead'>
                        ...
                        <tr className='unpaidPurchaseOrder-table-thead-tr'>
                            ...
                            <th className='unpaidPurchaseOrder-table-thead-tr-th'>{new Date(unpaidPurchaseOrderData?.createdAt).toUTCString()}</th>
                        </tr>
                        <tr className='unpaidPurchaseOrder-table-thead-tr'>
                            <th className='unpaidPurchaseOrder-table-thead-tr-th'>Remark</th>
                            <th className='unpaidPurchaseOrder-table-thead-tr-th'>{unpaidPurchaseOrderData?.remark ? unpaidPurchaseOrderData?.remark : "..."}</th>
                        </tr>
                        <tr className='unpaidPurchaseOrder-table-thead-tr'>
                            <th className='unpaidPurchaseOrder-table-thead-tr-th'>Is Paid</th>
                            <th className='unpaidPurchaseOrder-table-thead-tr-th'>{unpaidPurchaseOrderData?.isPaid ? "Paid" : "Unpaid"}</th>
                        </tr>
                    </thead>
                </table>
                    ...
                    <div className='carousel'>
                        ...
                        <div className='carousel-image-container'>
                            <img
                                ...
                                src={unpaidPurchaseOrderData?.billPhotos[currentPhotoIndex]?.secure_url}
