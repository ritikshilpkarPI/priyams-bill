...
router.post(API_PATHS.PURCHASE_ORDER.AUTO_PO_CREATE, isLoggedIn, checkLowStockAndCreateAutoPO)

router.post(API_PATHS.PURCHASE_ORDER.COMBINE_POS, isLoggedIn, combinePOsController);
