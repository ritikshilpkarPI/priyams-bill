...
router.post(API_PATHS.INVENTORY.POST_SOFT_DELETE_ITEM, isLoggedIn,softDeleteItem);
...
router.post(API_PATHS.INVENTORY.POST_FILTER_EXPIRY_DATES,isLoggedIn, filterExpiryDates);
...
router.get(API_PATHS.OPENCLOSE.GET_DAY_WISE_PROCEDURE, isLoggedIn, getDayWiseProcedures);
router.post(API_PATHS.OPENCLOSE.POST_NEW_PROCEDURE_OPEN, isLoggedIn, addOpenCloseProcedure);
router.post(
  API_PATHS.OPENCLOSE.POST_NEW_PROCEDURE_CLOSE, isLoggedIn,
  addOpenCloseProcedure
);
router.put(API_PATHS.OPENCLOSE.PUT_EDIT_PROCEDURE_OPEN, isLoggedIn, editOpenCloseProcedure);
router.put(
  API_PATHS.OPENCLOSE.PUT_EDIT_PROCEDURE_CLOSE, isLoggedIn,
  editOpenCloseProcedure
);

router.post(API_PATHS.PAYMENT.POST_SAVE_PAYMENT, isLoggedIn, savePayment);
router.post(
  `${API_PATHS.PAYMENT.POST_UPDATE_SAVED_PAYMENT}/:id`, isLoggedIn,
  updateSavedPayment
);
router.post(
  `${API_PATHS.PAYMENT.POST_DELETE_PAYMENT_BY_ID}/:id`, isLoggedIn,
  deletePaymentById
);
router.post(
  `${API_PATHS.PAYMENT.POST_UPDATE_PAYMENT_BY_ID}/:id`, isLoggedIn,
  updatePaymentById
);

router.get(API_PATHS.PURCHASE_ORDER.GET_ORDERS, isLoggedIn, getOrders);
router.get(`${API_PATHS.PURCHASE_ORDER.GET_ORDER_DETAILS}/:id`, isLoggedIn, getDetailsById);
router.get(
  `${API_PATHS.PURCHASE_ORDER.GET_INDIVIDUAL_PURCHASE_ORDER}/:id`, isLoggedIn,
  getPurchaseOrderByItem
);
router.post(API_PATHS.PURCHASE_ORDER.POST_ADD_NEW_ORDER, isLoggedIn, addOrder);
router.post(API_PATHS.PURCHASE_ORDER.POST_UPDATE_DETAILS, isLoggedIn, updateDetailsById);
...
router.post(
  `${API_PATHS.PURCHASE_ORDER.POST_UPDATE_SAVED_ORDER}/:id`, isLoggedIn,
  updateSavedOrders
);
router.post(
  `${API_PATHS.PURCHASE_ORDER.POST_DELETE_ITEM}/:id`, isLoggedIn,
  deleteOrderItemById
);
router.post(
  `${API_PATHS.PURCHASE_ORDER.POST_UPDATE_ORDER_BY_INDEX}/:id`, isLoggedIn,
  updateOrderByIndex
);
router.post(API_PATHS.PURCHASE_ORDER.GET_ORDERS_BY_QUERY, isLoggedIn, getOrdersByQuery);
...
//attendance APIs
router.post(
  API_PATHS.ATTENDANCE.POST_DAILY_ATTENDANCE_ARRIVAL, isLoggedIn,
  addDailyAttendanceArrival
);
router.post(
  API_PATHS.ATTENDANCE.POST_DAILY_ATTENDANCE_LEAVING, isLoggedIn,
  addDailyAttendanceLeaving
);
router.post(API_PATHS.ATTENDANCE.POST_DAILY_ATTENDANCE, isLoggedIn, getDatesWiseAttendance);
router.post(API_PATHS.ATTENDANCE.POST_MARK_ABSENT, isLoggedIn, markAbsent);
router.get(API_PATHS.ATTENDANCE.GET_MONTHLY_ATTENDANCE, isLoggedIn, getMonthlyAttendance);

router.post(
  `${API_PATHS.APPROVAL.POST_REJECT_ORDER}/:id`, isLoggedIn,
  isAdmin, isLoggedIn,
  rejectOrder
);
router.post(
  `${API_PATHS.APPROVAL.POST_APPROVE_ORDER}/:id`, isLoggedIn,
  isAdmin, isLoggedIn,
  approveOrder
);
...
router.post(
  `${API_PATHS.REPORT.POST_GET_DATE_RANGE_REPORT}/:filterName`, isLoggedIn,
  getDateRangeReport
);
...
router.delete(`${API_PATHS.STAFF.DELETE_STAFF}/:username`, isLoggedIn, deleteStaff);
...
router.delete(`${API_PATHS.EXPENSE.DELETE_EXPENSE}/:id`, isLoggedIn, deleteExpense);
router.put(`${API_PATHS.EXPENSE.PUT_EXPENSE}/:id`, isLoggedIn, updateExpense);
router.get(`${API_PATHS.EXPENSE.GET_EXPENSE}/:date`, isLoggedIn, sendDayExpenses);
